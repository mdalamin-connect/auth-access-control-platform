...
<style>
   ...
   .mirsaige-app-breadcrumbs-title,
    ...
    .mirsaige-supplier-profile-card {
        background: var(--mirsaige-dark-blue);
        border-radius: 10px;
        padding: 1.5rem;
        border: 1px solid rgba(255, 178, 62, 0.1);
    ...
    .mirsaige-supplier-profile-icon {
        width: 150px;
        height: 150px;
        border-radius: 50%;
        background: linear-gradient(135deg, var(--mirsaige-accent), var(--mirsaige-gold));
        display: flex;
        align-items: center;
    ...
    .mirsaige-supplier-profile-info {
        flex: 1;
    }

    .mirsaige-supplier-profile-name {
        font-size: 1.5rem;
        font-weight: 600;
        color: var(--mirsaige-white);
    ...
    .mirsaige-supplier-profile-company {
        font-size: 1rem;
        color: var(--mirsaige-accent);
        margin-bottom: 1rem;
        display: flex;
    ...
    .mirsaige-supplier-profile-contact {
        font-size: 0.9rem;
        color: var(--mirsaige-text);
        display: flex;
        align-items: center;
...
<div class="mirsaige-details-container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="mirsaige-app-breadcrumbs-title">Supplier Details</h1>
            <div class="mirsaige-app-breadcrumbs">
                ...
                <div class="mirsaige-app-breadcrumb">
                    <a href="{{ route('suppliers.show', $supplier->id) }}" class="active">Supplier Details</a>
                </div>
            </div>
        </div>
    ...
    <!-- Supplier Profile Card -->
    <div class="mirsaige-supplier-profile-card">
        <div class="mirsaige-supplier-profile-icon">
            <i class='bx bxs-building-house'></i>
        </div>
        
        <div class="mirsaige-supplier-profile-info">
            <h2 class="mirsaige-supplier-profile-name">{{ $supplier->name }}</h2>
            <div class="mirsaige-supplier-profile-company">
                <i class='bx bx-building'></i>
                {{ $supplier->company_name }}
            </div>
            <div class="mirsaige-supplier-profile-contact">
    ...
    <div class="mirsaige-details-header">
        <div>
            ...
            <p class="mirsaige-details-subtitle">
                ...
                Last updated: {{ $supplier->updated_at->format('M d, Y \a\t h:i A') }}
            </p>
        </div>
    </div>
    ...
    <div class="mirsaige-details-grid">
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $supplier->id }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $supplier->name }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $supplier->company_name }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $supplier->phone }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $supplier->email }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $supplier->address ?? 'Not provided' }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $supplier->created_at->format('M d, Y \a\t h:i A') }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $supplier->creator->name ?? 'System' }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $supplier->updated_at->format('M d, Y \a\t h:i A') }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $supplier->updater->name ?? 'System' }}</div>
        </div>
    </div>
    ...
    <div class="mirsaige-details-actions">
        ...
        <a href="{{ route('suppliers.edit', $supplier->id) }}" class="mirsaige-details-action-btn edit">
            <i class='bx bx-edit'></i> Edit Supplier
        </a>
        @endif
        
        <a href="{{ route('suppliers.index') }}" class="mirsaige-details-action-btn back">
