...
<style>
    ...
    .mirsaige-purchase-table tr.highlight td {
        background: rgba(255, 178, 62, 0.1);
        color: var(--mirsaige-white);
    }
...
<div class="mirsaige-purchase-container">
    <div class="mirsaige-purchase-header">
        <div>
            <h1 class="mirsaige-app-breadcrumbs-title">Purchase Reports</h1>
            <div class="mirsaige-app-breadcrumbs">
                ...
                <div class="mirsaige-app-breadcrumb">
                    <a href="#" class="active">Purchase Reports</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mirsaige-search-box">
        ...
        <input type="text" id="searchInput" class="mirsaige-search-input" placeholder="Search purchase records..." onkeyup="search()">
    </div>

    <!-- Table Container -->
    <div class="mirsaige-purchase-table-wrapper">
        <div class="mirsaige-purchase-table-container">
            <table class="mirsaige-purchase-table" id="purchaseTable">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Project</th>
    ...
    <div class="mirsaige-pagination">
        <div class="mirsaige-pagination-info">
            Total: {{ $purchasedetails->total() }} records
        </div>
