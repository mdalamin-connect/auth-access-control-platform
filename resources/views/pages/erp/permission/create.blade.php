...
<style>
    ...
    /* Form Container */
    .mirsaige-permission-form-container {
        background: var(--mirsaige-dark-blue);
        border-radius: 8px;
        padding: var(--mirsaige-space-md);
    ...
    .mirsaige-permission-form-container:hover {
        box-shadow: 0 6px 25px rgba(0, 0, 0, 0.2);
        border-color: rgba(255, 178, 62, 0.2);
    }

    /* Form Styles */
    .mirsaige-permission-form {
        display: grid;
    ...
    <div class="mirsaige-permission-header">
        <div>
            <div class="mirsaige-app-breadcrumbs">
                ...
                <div class="mirsaige-app-breadcrumb">
                    <a href="{{ route('permissions.create') }}" class="active">Create Permission</a>
                </div>
            </div>
        </div>
        
        <a href="{{ route('permissions.index') }}" class="mirsaige-app-breadcrumbs-btn">
            <i class="fa-solid fa-list-check"></i>Permission List
        </a>
    </div>

    <div class="mirsaige-permission-form-container mirsaige-animated-form">
        <form action="{{ route('permissions.store') }}" method="post" enctype="multipart/form-data" class="mirsaige-permission-form">
            @csrf
            ...
            <div class="mirsaige-form-group full-width">
                ...
                <input type="text" class="mirsaige-form-control" name="name" id="name" placeholder="Enter permission name" required>
                @error('name')
            ...
            <div class="mirsaige-form-actions">
                <button type="submit" class="mirsaige-form-submit">
                   <i class="fa-solid fa-floppy-disk"></i> Save Permission
                </button>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const form = document.querySelector('.mirsaige-permission-form');
        if (form) {
