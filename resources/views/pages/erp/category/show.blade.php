...
<style>
    ...
    .mirsaige-department-icon {
        font-size: 3rem;
        color: var(--mirsaige-accent);
    }

    .mirsaige-department-info {
        flex: 1;
    }

    .mirsaige-department-name {
        font-size: 1.5rem;
        font-weight: 600;
        color: var(--mirsaige-white);
...
<div class="mirsaige-details-container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="mirsaige-app-breadcrumbs-title">Category Details</h1>
            <div class="mirsaige-app-breadcrumbs">
                ...
                <div class="mirsaige-app-breadcrumb">
                    <a href="{{ route('categories.show', $category->id) }}" class="active">Category Details</a>
                </div>
            </div>
        </div>
    ...
    <!-- Department Card -->
    <div class="mirsaige-department-card">
        <div class="mirsaige-department-icon">
            <i class='bx bx-category'></i>
        </div>
        <div class="mirsaige-department-info">
            <h2 class="mirsaige-department-name">{{ $category->name }}</h2>
            <div class="mirsaige-department-label">
    ...
    <div class="mirsaige-details-header">
        <div>
            <h1 class="mirsaige-details-title">
                <i class='bx bxs-category mirsaige-details-title-icon'></i>
    ...
    <div class="mirsaige-details-grid">
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $category->id }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $category->name }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $category->department->name }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $category->created_at->format('M d, Y \a\t h:i A') }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $category->creator->name ?? 'System' }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $category->updated_at->format('M d, Y \a\t h:i A') }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $category->updater->name ?? 'System' }}</div>
        </div>
    </div>
    ...
    <div class="mirsaige-details-actions">
        ...
        <a href="{{ route('categories.edit', $category->id) }}" class="mirsaige-details-action-btn edit">
            <i class='bx bx-edit'></i> Edit Category
        </a>
        @endif
        
        <a href="{{ route('categories.index') }}" class="mirsaige-details-action-btn back">
