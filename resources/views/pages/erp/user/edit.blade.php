...
<style>
    ...
    .mirsaige-forgot-password-btn:hover {
    ...
    @media (max-width: 992px) {
        ...
        .mirsaige-form-submit,
        .mirsaige-form-reset {
            font-size: var(--mirsaige-space-xs);
        }
    }
...
<div class="mirsaige-user-container">
    <div class="mirsaige-user-header">
        <div class="mirsaige-app-breadcrumbs">
            ...
            <div class="mirsaige-app-breadcrumb">
                <a href="{{ route('users.edit', $user->id) }}" class="active">Edit User</a>
            </div>
        </div>

        <a href="{{ route('users.index') }}" class="mirsaige-app-breadcrumbs-btn">
            <i class="fa-solid fa-list-check"></i> Users List
        </a>
    </div>
            ...
            <div class="mirsaige-user-form-wrapper">
                ...
                <div class="mirsaige-form-section">
                    ...
                    <div class="mirsaige-form-group">
                        ...
                        <input type="text" class="mirsaige-form-control" name="name" id="name" placeholder="Enter full name" value="{{ old('name', $user->name) }}" required>
                        @error('name')
                    ...
                    <div class="mirsaige-form-group">
                        ...
                        <input type="text" class="mirsaige-form-control" name="username" id="username" placeholder="Enter username" value="{{ old('username', $user->username) }}" required>
                        @error('username')
                        <small class="mirsaige-form-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mirsaige-form-group">
                        ...
                        <input type="email" class="mirsaige-form-control" name="email" id="email" placeholder="Enter email" value="{{ old('email', $user->email) }}" required>
                        @error('email')
                        <small class="mirsaige-form-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mirsaige-image-section">
                        <div class="mirsaige-image-preview-container">
                            <div class="mirsaige-image-preview" id="imagePreview">
                                @if($user->photo)
                                    <img src="{{ asset('img/users/' . $user->photo) }}" alt="User Photo" class="mirsaige-image-preview">
                                @else
                        ...
                        <div class="mirsaige-image-upload-actions">
                            ...
                            <button type="button" class="mirsaige-image-remove-btn" id="removeBtn" style="{{ $user->photo ? 'display: flex' : 'display: none' }}">
                ...
                <div class="mirsaige-form-section">
                    <div class="mirsaige-form-group">
                        ...
                        <input type="text" class="mirsaige-form-control" name="phone" id="phone" placeholder="Enter phone number" value="{{ old('phone', $user->phone) }}" pattern="[0-9]{10,15}">
                        @error('phone')
                        <small class="mirsaige-form-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mirsaige-form-group">
                        ...
                        <input type="text" class="mirsaige-form-control" name="address" id="address" placeholder="Enter address" value="{{ old('address', $user->address) }}">
                        @error('address')
                        <small class="mirsaige-form-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="mirsaige-form-actions">
                        ...
                        <a href="{{ route('forget.password.get') }}" class="mirsaige-forgot-password-btn">
