...
<main class="mirsaige-app-main">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <div class="mirsaige-app-breadcrumbs">
                    ...
                    <div class="mirsaige-app-breadcrumb">
                        <a href="{{ route('uoms.edit', $uom->id) }}" class="active">Edit UOM</a>
                    </div>
                </div>
                @if(in_array($user_role_id, [1, 2]))
                    <div class="mirsaige-updater-info">
                        <i class="bx bx-history"></i>
                        Last updated by: {{ $uom->updater->name ?? 'System' }} on {{ $uom->updated_at->format('M d, Y h:i A') }}
                    </div>
                @endif
            </div>
        ...
        <!-- Form Container -->
        <div class="mirsaige-uom-container mirsaige-animated-form">
            <form action="{{ route('uoms.update', $uom) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="mirsaige-form-input" name="name" id="name" 
                           placeholder="Enter UOM name" value="{{ $uom->name }}" required>
                    @error('name')
                ...
                <div class="d-flex gap-3 mirsaige-form-actions mt-4">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (resetBtn) {
            resetBtn.addEventListener('click', function() {
                ...
                document.querySelector('input[name="name"]').value = '{{ $uom->name }}';
