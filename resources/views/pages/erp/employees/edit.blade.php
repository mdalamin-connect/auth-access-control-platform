...
<div class="mirsaige-employee-container">
    <div class="mirsaige-employee-header">
        <div class="mirsaige-app-breadcrumbs">
            ...
            <div class="mirsaige-app-breadcrumb">
                <a href="{{ route('employees.edit', $employee->id) }}" class="active">Edit Employee</a>
            </div>
        </div>
    ...
    <div class="mirsaige-employee-form-container">
        <form action="{{ route('employees.update', $employee) }}" method="post" enctype="multipart/form-data" id="employeeEditForm">
            @csrf
            @method('PUT')
            ...
            <div class="mirsaige-employee-form-wrapper">
                ...
                <div class="mirsaige-form-half-section">
                    ...
                    <div class="mirsaige-form-group">
                        ...
                        <input type="text" class="mirsaige-form-control" name="name" id="name" placeholder="Enter full name" value="{{ old('name', $employee->name) }}" required>
                        @error('name')
                    ...
                    <div class="mirsaige-form-group">
                        ...
                        <input type="email" class="mirsaige-form-control" name="email" id="email" placeholder="Enter email" value="{{ old('email', $employee->email) }}" required>
                        @error('email')
                        <small class="mirsaige-form-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mirsaige-form-group">
                        ...
                        <input type="text" class="mirsaige-form-control" name="phone" id="phone" placeholder="Enter phone number" value="{{ old('phone', $employee->phone) }}" pattern="[0-9]{10,15}">
                        @error('phone')
                        <small class="mirsaige-form-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mirsaige-form-group">
                        ...
                        <input type="text" class="mirsaige-form-control" name="address" id="address" placeholder="Enter address" value="{{ old('address', $employee->address) }}">
                        @error('address')
                        <small class="mirsaige-form-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mirsaige-form-group">
                        ...
                        <input type="text" class="mirsaige-form-control" name="nid" id="nid" placeholder="Enter national ID number" value="{{ old('nid', $employee->nid) }}">
                        @error('nid')
                        <small class="mirsaige-form-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="mirsaige-form-half-section">
                    ...
                    <div class="mirsaige-form-group">
                        ...
                        <input type="number" class="mirsaige-form-control" name="salary" id="salary" placeholder="Enter salary" value="{{ old('salary', $employee->salary) }}" required>
                        @error('salary')
                        <small class="mirsaige-form-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mirsaige-form-group">
                        ...
                        <input type="date" class="mirsaige-form-control" name="joining_date" id="joining_date" value="{{ old('joining_date', $employee->joining_date) }}" required>
                        @error('joining_date')
                        <small class="mirsaige-form-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mirsaige-image-section" id="imageUploadSection">
                        <div class="mirsaige-image-preview-container">
                            <div class="mirsaige-image-preview" id="imagePreview">
                                @if($employee->photo)
                                    <img src="{{ asset('img/employees/' . $employee->photo) }}" alt="Employee Photo" class="mirsaige-image-preview">
                                @else
                        ...
                        <div class="mirsaige-image-upload-actions">
                            ...
                            <button type="button" class="mirsaige-image-remove-btn" id="removeBtn" style="{{ $employee->photo ? 'display: flex' : 'display: none' }}">
                    ...
                    <div class="mirsaige-cv-section" id="cvUploadSection">
                        <div class="mirsaige-cv-preview-container">
                            <div class="mirsaige-cv-placeholder" id="cvPreview">
                                @if($employee->cv)
                                    ...
                                    <span>{{ basename($employee->cv) }}</span>
                                @else
                                    <i class="fa-solid fa-file-pdf"></i>
                                    <span>Upload CV</span>
                                @endif
                        ...
                        <div class="mirsaige-cv-upload-actions">
                            ...
                            <button type="button" class="mirsaige-cv-upload-btn" id="uploadCvBtn">
                                <i class="fa-solid fa-upload"></i> Change CV
                            </button>
                            <button type="button" class="mirsaige-cv-remove-btn" id="removeCvBtn" style="{{ $employee->cv ? 'display: flex' : 'display: none' }}">
