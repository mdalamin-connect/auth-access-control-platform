...
<div class="mirsaige-details-container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="mirsaige-app-breadcrumbs-title">Designation Details</h1>
            <div class="mirsaige-app-breadcrumbs">
                ...
                <div class="mirsaige-app-breadcrumb">
                    <a href="{{ route('designations.show', $designation->id) }}" class="active">Designation Details</a>
                </div>
            </div>
        </div>
    ...
    <div class="mirsaige-details-header">
        <div>
            <h1 class="mirsaige-details-title">
                <i class='bx bxs-id-card mirsaige-details-title-icon'></i>
                {{ $designation->name }}
            </h1>
            <p class="mirsaige-details-subtitle">
                <i class='bx bx-time-five'></i>
                Last updated: {{ $designation->updated_at->format('M d, Y \a\t h:i A') }}
            </p>
        </div>
    </div>
    ...
    <div class="mirsaige-details-grid">
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $designation->id }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $designation->name }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $designation->created_at->format('M d, Y \a\t h:i A') }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $designation->creator->name ?? 'System' }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $designation->updated_at->format('M d, Y \a\t h:i A') }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $designation->updater->name ?? 'System' }}</div>
        </div>
    </div>
    ...
    <div class="mirsaige-details-actions">
        ...
        <a href="{{ route('designations.edit', $designation->id) }}" class="mirsaige-details-action-btn edit">
            <i class='bx bx-edit'></i> Edit Designation
        </a>
        @endif
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        console.log('Designation details page loaded');
    });
</script>
@endsection