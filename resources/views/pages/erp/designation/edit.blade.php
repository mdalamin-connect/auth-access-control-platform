...
<style>
    ...
    .mirsaige-designation-container:hover {
...
<main class="mirsaige-app-main">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <div class="mirsaige-app-breadcrumbs">
                    ...
                    <div class="mirsaige-app-breadcrumb">
                        <a href="{{ route('designations.edit', $designation->id) }}" class="active">Edit Designation</a>
                    </div>
                </div>
        ...
        <!-- Form Container -->
        <div class="mirsaige-designation-container mirsaige-animated-form">
            <form action="{{ route('designations.update', $designation) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <textarea class="mirsaige-form-input mirsaige-form-textarea" 
                          ...
                          placeholder="Enter description">{{ $designation->description }}</textarea>
                    @error('description')
                        <small class="text-danger" style="color: #ff6b6b !important;">{{ $message }}</small>
                    @enderror
                </div>
