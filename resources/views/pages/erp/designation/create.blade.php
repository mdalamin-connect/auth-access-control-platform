...
<style>
    ...
    /* Form Container */
    .mirsaige-designation-form-container {
        background: var(--mirsaige-dark-blue);
        border-radius: 8px;
        padding: var(--mirsaige-space-md);
    ...
    .mirsaige-designation-form-container:hover {
        box-shadow: 0 6px 25px rgba(0, 0, 0, 0.2);
        border-color: rgba(255, 178, 62, 0.2);
    }

    /* Form Styles */
    .mirsaige-designation-form {
        display: grid;
    ...
    <div class="mirsaige-designation-header">
        <div>
            <div class="mirsaige-app-breadcrumbs">
                ...
                <div class="mirsaige-app-breadcrumb">
                    <a href="{{ route('designations.create') }}" class="active">Create Designation</a>
                </div>
            </div>
        </div>
        
        <a href="{{ route('designations.index') }}" class="mirsaige-app-breadcrumbs-btn">
            <i class="fa-solid fa-list-check"></i>Designation List
        </a>
    </div>

    <div class="mirsaige-designation-form-container mirsaige-animated-form">
        <form action="{{ route('designations.store') }}" method="post" enctype="multipart/form-data" class="mirsaige-designation-form">
            @csrf
            ...
            <div class="mirsaige-form-group full-width">
                ...
                <input type="text" class="mirsaige-form-control" name="name" id="name" placeholder="Enter designation name" required>
                @error('name')
            ...
            <div class="mirsaige-form-group full-width">
                ...
                <textarea class="mirsaige-form-control mirsaige-form-textarea" name="description" id="description" placeholder="Enter description"></textarea>
                @error('description')
                    <small class="text-danger" style="color: #ff6b6b !important;">{{ $message }}</small>
                @enderror
            </div>
            ...
            <div class="mirsaige-form-actions">
                <button type="submit" class="mirsaige-form-submit">
                   <i class="fa-solid fa-floppy-disk"></i> Save Designation
                </button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (resetBtn) {
            resetBtn.addEventListener('click', function() {
                ...
                this.innerHTML = '<i class="bx bx-check"></i> Form Cleared';
                this.disabled = true;
        ...
        const form = document.querySelector('.mirsaige-designation-form');
        if (form) {
