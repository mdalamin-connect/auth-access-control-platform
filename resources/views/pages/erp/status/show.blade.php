...
<div class="mirsaige-details-container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="mirsaige-app-breadcrumbs-title">Status Details</h1>
            <div class="mirsaige-app-breadcrumbs">
                ...
                <div class="mirsaige-app-breadcrumb">
                    <a href="{{ route('status.show', $status->id) }}" class="active">Status Details</a>
                </div>
            </div>
        </div>

        <a href="{{ route('status.index') }}" class="mirsaige-app-breadcrumbs-btn">
    ...
    <div class="mirsaige-details-header">
        <div>
            <h1 class="mirsaige-details-title">
                <i class='bx bx-task mirsaige-details-title-icon'></i>
                {{ $status->name }}
            </h1>
            <p class="mirsaige-details-subtitle">
                <i class='bx bx-time-five'></i>
                Last updated: {{ $status->updated_at->format('M d, Y \a\t h:i A') }}
            </p>
        </div>
    </div>
    ...
    <div class="mirsaige-details-grid">
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $status->id }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $status->name }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $status->created_at->format('M d, Y \a\t h:i A') }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $status->creator->name ?? 'System' }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $status->updated_at->format('M d, Y \a\t h:i A')}}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $status->updater->name ?? 'System' }}</div>
        </div>
    </div>
    ...
    <div class="mirsaige-description-card">
        ...
        <div class="mirsaige-description-content">
            {{ $status->descriptions ?: 'No description provided' }}
        </div>
    </div>
    ...
    <div class="mirsaige-details-actions">
        ...
        <a href="{{ route('status.edit', $status->id) }}" class="mirsaige-details-action-btn edit">
            <i class='bx bx-edit'></i> Edit Status
        </a>
        @endif
        
        <a href="{{ route('status.index') }}" class="mirsaige-details-action-btn back">
            <i class='bx bx-arrow-back'></i> Back to Status
        </a>
    </div>
</div>
@endsection
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        console.log('Status details page loaded');
    });
</script>
@endsection