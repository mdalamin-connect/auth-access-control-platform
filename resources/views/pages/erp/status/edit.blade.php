...
<style>
    ...
    .mirsaige-status-container:hover {
...
<main class="mirsaige-app-main">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <div class="mirsaige-app-breadcrumbs">
                    ...
                    <div class="mirsaige-app-breadcrumb">
                        <a href="{{ route('status.edit', $status->id) }}" class="active">Edit Status</a>
                    </div>
                </div>
                <div class="mirsaige-last-updated">
                    Last updated by: {{ $status->updater->name ?? 'System' }} on {{ $status->updated_at->format('M d, Y h:i A') }}
                </div>
            </div>
        ...
        <!-- Form Container -->
        <div class="mirsaige-status-container mirsaige-animated-form">
            <form action="{{ route('status.update', $status) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="mirsaige-form-input" name="name" id="name" 
                           placeholder="Enter status name" value="{{ $status->name }}" required>
                    @error('name')
                ...
                <div class="mb-4">
                    ...
                    <textarea class="mirsaige-form-input mirsaige-form-textarea" 
                          ...
                          placeholder="Enter description">{{ $status->descriptions }}</textarea>
                    @error('descriptions')
                        <small class="text-danger" style="color: #ff6b6b !important;">{{ $message }}</small>
                    @enderror
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Custom reset functionality - CLEARS the form
