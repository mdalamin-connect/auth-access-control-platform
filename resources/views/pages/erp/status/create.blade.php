...
<style>
    ...
    /* Form Container */
    .mirsaige-status-form-container {
        background: var(--mirsaige-dark-blue);
        border-radius: 8px;
        padding: var(--mirsaige-space-md);
    ...
    .mirsaige-status-form-container:hover {
        box-shadow: 0 6px 25px rgba(0, 0, 0, 0.2);
        border-color: rgba(255, 178, 62, 0.2);
    }

    /* Form Styles */
    .mirsaige-status-form {
        display: grid;
    ...
    <div class="mirsaige-status-header">
        <div>
            <div class="mirsaige-app-breadcrumbs">
                ...
                <div class="mirsaige-app-breadcrumb">
                    <a href="{{ route('status.create') }}" class="active">Create Status</a>
                </div>
            </div>
        </div>
        
        <a href="{{ route('status.index') }}" class="mirsaige-app-breadcrumbs-btn">
            <i class="fa-solid fa-list-check"></i>Status List
        </a>
    </div>

    <div class="mirsaige-status-form-container mirsaige-animated-form">
        <form action="{{ route('status.store') }}" method="post" enctype="multipart/form-data" class="mirsaige-status-form">
            @csrf
            ...
            <div class="mirsaige-form-group full-width">
                ...
                <input type="text" class="mirsaige-form-control" name="name" id="name" placeholder="Enter status name" required>
                @error('name')
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const form = document.querySelector('.mirsaige-status-form');
        if (form) {
