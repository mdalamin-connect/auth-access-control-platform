...
<style>
    /* Base Styles */
    .mirsaige-transaction-type-container {
    ...
    /* Header Section */
    .mirsaige-transaction-type-header {
        display: flex;
    ...
    /* Form Container */
    .mirsaige-transaction-type-form-container {
        background: var(--mirsaige-dark-blue);
        border-radius: 8px;
        padding: var(--mirsaige-space-md);
    ...
    .mirsaige-transaction-type-form-container:hover {
        box-shadow: 0 6px 25px rgba(0, 0, 0, 0.2);
        border-color: rgba(255, 178, 62, 0.2);
    }

    /* Form Styles */
    .mirsaige-transaction-type-form {
        display: grid;
...
@section('page')
<div class="mirsaige-transaction-type-container">
    <div class="mirsaige-transaction-type-header">
        <div>
            <div class="mirsaige-app-breadcrumbs">
                ...
                <div class="mirsaige-app-breadcrumb">
                    <a href="{{ route('transaction-types.create') }}" class="active">Create Transaction Type</a>
                </div>
            </div>
        </div>
        
        <a href="{{ route('transaction-types.index') }}" class="mirsaige-app-breadcrumbs-btn">
            <i class="fa-solid fa-list-check"></i>Transaction Type List
        </a>
    </div>

    <div class="mirsaige-transaction-type-form-container mirsaige-animated-form">
        <form action="{{ route('transaction-types.store') }}" method="post" enctype="multipart/form-data" class="mirsaige-transaction-type-form">
            @csrf
            ...
            <div class="mirsaige-form-group full-width">
                ...
                <input type="text" class="mirsaige-form-control" name="name" id="name" placeholder="Enter transaction type name" required>
                @error('name')
            ...
            <div class="mirsaige-form-group full-width">
                ...
                <textarea class="mirsaige-form-control mirsaige-form-textarea" name="descriptions" id="descriptions" placeholder="Enter description"></textarea>
                @error('descriptions')
                    <small class="text-danger" style="color: #ff6b6b !important;">{{ $message }}</small>
                @enderror
            </div>
            ...
            <div class="mirsaige-form-actions">
                <button type="submit" class="mirsaige-form-submit">
                   <i class="fa-solid fa-floppy-disk"></i> Save Transaction Type
                </button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (resetBtn) {
            resetBtn.addEventListener('click', function() {
                ...
                document.querySelector('textarea[name="descriptions"]').value = '';
        ...
        const form = document.querySelector('.mirsaige-transaction-type-form');
        if (form) {
