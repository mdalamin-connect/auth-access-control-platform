...
@section('title', 'Transaction Type Details')
@section('style')
<style>
...
<div class="mirsaige-details-container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="mirsaige-app-breadcrumbs-title">Transaction Type Details</h1>
            <div class="mirsaige-app-breadcrumbs">
                ...
                <div class="mirsaige-app-breadcrumb">
                    <a href="{{ route('transaction-types.show', $transactiontype->id) }}" class="active">Transaction Type Details</a>
                </div>
            </div>
        </div>
    ...
    <div class="mirsaige-details-header">
        <div>
            <h1 class="mirsaige-details-title">
                <i class='bx bx-transfer-alt mirsaige-details-title-icon'></i>
                {{ $transactiontype->name }}
            </h1>
            <p class="mirsaige-details-subtitle">
                <i class='bx bx-time-five'></i>
                Last updated: {{ $transactiontype->updated_at->format('M d, Y \a\t h:i A') }}
            </p>
        </div>
    </div>
    ...
    <div class="mirsaige-details-grid">
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $transactiontype->id }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $transactiontype->name }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $transactiontype->created_at->format('M d, Y \a\t h:i A') }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $transactiontype->creator->name ?? 'System' }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $transactiontype->updated_at->format('M d, Y') }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $transactiontype->updater->name ?? 'System' }}</div>
        </div>
    </div>

    <!-- Description Card -->
    <div class="mirsaige-description-card">
        <div class="mirsaige-detail-label">
            <i class='bx bx-text'></i>
            Description
        </div>
        <div class="mirsaige-description-content">
            {{ $transactiontype->descriptions ?: 'No description provided' }}
        </div>
    </div>
    ...
    <div class="mirsaige-details-actions">
        ...
        <a href="{{ route('transaction-types.edit', $transactiontype->id) }}" class="mirsaige-details-action-btn edit">
            <i class='bx bx-edit'></i> Edit Transaction Type
        </a>
        @endif
        
        <a href="{{ route('transaction-types.index') }}" class="mirsaige-details-action-btn back">
            <i class='bx bx-arrow-back'></i> Back to Transaction Types
        </a>
    </div>
</div>
@endsection
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        console.log('Transaction type details page loaded');
    });
</script>
@endsection