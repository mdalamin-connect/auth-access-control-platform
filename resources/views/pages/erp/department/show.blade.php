...
<div class="mirsaige-details-container">
    <!-- Breadcrumb Navigation -->
      <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="mirsaige-app-breadcrumbs-title"> Department Details</h1>
                <div class="mirsaige-app-breadcrumbs">
                    ...
                    <div class="mirsaige-app-breadcrumb">
                        <a href="{{ route('departments.create') }}" class="active">Department Details</a>
                    </div>
                </div>
            </div>
           

                <a href="{{ route('departments.index', $department->id) }}" class="mirsaige-app-breadcrumbs-btn">
    ...
    <div class="mirsaige-details-header">
        <div>
            <h1 class="mirsaige-details-title">
                <i class='bx bxs-building mirsaige-details-title-icon'></i>
                {{ $department->name }}
            </h1>
            <p class="mirsaige-details-subtitle">
                <i class='bx bx-time-five'></i>
                Last updated: {{ $department->updated_at->format('M d, Y \a\t h:i A') }}
            </p>
        </div>
    </div>
    ...
    <div class="mirsaige-details-grid">
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $department->id }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $department->name }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $department->created_at->format('M d, Y \a\t h:i A') }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $department->creator->name ?? 'System' }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $department->updated_at->format('M d, Y \a\t h:i A') }}</div>
        </div>
        ...
        <div class="mirsaige-detail-card">
            ...
            <div class="mirsaige-detail-value">{{ $department->updater->name ?? 'System' }}</div>
        </div>
    </div>
    <!-- Description Card -->
    ...
    <div class="mirsaige-details-actions">
        ...
        <a href="{{ route('departments.edit', $department->id) }}" class="mirsaige-details-action-btn edit">
