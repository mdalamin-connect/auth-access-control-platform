...
<style>
    ...
    /* Form Container */
    .mirsaige-department-form-container {
        background: var(--mirsaige-dark-blue);
        border-radius: 8px;
        padding: var(--mirsaige-space-md);
    ...
    .mirsaige-department-form-container:hover {
        box-shadow: 0 6px 25px rgba(0, 0, 0, 0.2);
        border-color: rgba(255, 178, 62, 0.2);
    }

    /* Form Styles */
    .mirsaige-department-form {
        display: grid;
    ...
    <div class="mirsaige-department-header">
        <div>
            <div class="mirsaige-app-breadcrumbs">
                ...
                <div class="mirsaige-app-breadcrumb">
                    <a href="{{ route('departments.create') }}" class="active">Create Department</a>
                </div>
            </div>
        </div>
        
        <a href="{{ route('departments.index') }}" class="mirsaige-app-breadcrumbs-btn">
            <i class="fa-solid fa-list-check"></i>Department List
        </a>
    </div>

    <div class="mirsaige-department-form-container mirsaige-animated-form">
        <form action="{{ route('departments.store') }}" method="post" enctype="multipart/form-data" class="mirsaige-department-form">
            @csrf
            ...
            <div class="mirsaige-form-group full-width">
                ...
                <input type="text" class="mirsaige-form-control" name="name" id="name" placeholder="Enter department name" required>
                @error('name')
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const form = document.querySelector('.mirsaige-department-form');
        if (form) {
